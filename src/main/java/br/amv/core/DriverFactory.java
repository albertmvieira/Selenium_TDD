...
import br.amv.core.Propriedades.TipoExecucao;
...
public class DriverFactory {
	...
	public static WebDriver initDriver(){
		...
		if(Propriedades.TIPO_EXECUCAO == TipoExecucao.NUVEM) {
			...
			try {
//				Necessita criar conta trial no Saucelabs
				driver = new RemoteWebDriver(new URL("http://albertmvieira:informarchave@ondemand.saucelabs.com:80/wd/hub"), cap);
			} catch (MalformedURLException e) {
				System.err.println("Falha na conexão com o GRID");
				e.printStackTrace();
			}
